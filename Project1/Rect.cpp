...
Rect::Rect():mCenter(0,0,0),mWidth(10),mHeight(10), mScalse(1.0f)
{
}

Rect::Rect(DirectX::XMFLOAT3& inc, float inw, float inh):mCenter(inc), mWidth(inw), mHeight(inh), mScalse(1.0f)
{
}
...
{
	return mCenter.x - mWidth * mScalse / 2.0f;
}

float Rect::GetUp() const
{
	return mCenter.y + mHeight * mScalse / 2.0f;
}
