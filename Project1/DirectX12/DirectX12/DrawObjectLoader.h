...
protected:
	File* mFp;
	std::wstring mRelativePath;//‘Š‘ÎƒpƒX•Û‘¶—p
	...
	virtual void CreateCommandList(Microsoft::WRL::ComPtr<ID3D12Device>& dev);
	virtual void CreateCommandAllocator(Microsoft::WRL::ComPtr<ID3D12Device>& dev);
private:
};
