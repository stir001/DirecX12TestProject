...
public:
	...
	virtual void SetRootSignature(std::shared_ptr<RootSignatureObject>& rootsignature) = 0;
	virtual void SetPipelineState(std::shared_ptr<PipelineStateObject>& pipelinestate) = 0;
