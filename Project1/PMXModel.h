...
public:
	...
	PMXPlane					planes;
	std::vector<TextBuffer>		texPath;
	std::vector<PMXMatarial>	 materials;
	std::vector<PMXBoneData>	 bonedata;
	std::vector<PMXMorph>		morphDatas;
	std::vector<PMXOutLine>		outline;
	std::vector<PMXRigidBody>	rigid;
